...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r-4 border-black" aria-label="Sidebar">
  <div class="h-full px-3 py-4 overflow-y-auto bg-[#F9F6EE] dark:bg-gray-800">
     <ul class="space-y-2 font-medium">
        <li>
           <a href="#" class="flex items-center p-2 text-purple-400 rounded-lg dark:text-white hover:bg-gray-100 hover:text-purple-500 dark:hover:bg-gray-700 group mt-14">
            <svg class="w-5 h-5 text-purple-400 transition duration-75 dark:text-gray-400 group-hover:text-purple-500 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
     ...
     <ul class="pt-4 mt-4 space-y-2 font-medium border-t-4 border-black dark:border-gray-700">
        <li>
  ...
  <!-- <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700"> -->
    <div class="relative overflow-x-auto rounded-2xl border-b-8 border-r-8 border-t-2 border-l-2 border-black">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead class="text-xs text-gray-700 uppercase bg-[#FAAB36] dark:bg-gray-700 dark:text-gray-400 border-b-2 border-black">
              <tr>
